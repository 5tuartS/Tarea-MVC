...
public class Panel1 extends JPanel {
    ...
    JLabel event = new JLabel("Descripción del Evento");
    JLabel email = new JLabel("Correo electrónico");
    JLabel date = new JLabel("Fecha");
    JLabel freq = new JLabel("Frecuencia");
    ...
    JRadioButton weekly = new JRadioButton("Semanal");
    JRadioButton monthly = new JRadioButton("Mensual");

    ButtonGroup grupoCheckboxes = new ButtonGroup();

    JCheckBox alarm = new JCheckBox("Alarma");
